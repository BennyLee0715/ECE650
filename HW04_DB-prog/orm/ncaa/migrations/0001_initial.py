# Generated by Django 2.1.7 on 2019-03-16 02:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ncaa.Color')),
                ('state_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ncaa.State')),
            ],
        ),
        migrations.AddField(
            model_name='player',
            name='team_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ncaa.Team'),
        ),
    ]
